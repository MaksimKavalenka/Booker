...
public abstract class MessageConstants {
    ...
    public static final String UPLOAD_FILE_ERROR_MESSAGE   = "You either did not specify a file to upload or are trying to upload a file to a protected or nonexistent location";
    public static final String VALIDATION_MESSAGE          = "All required attributes must be filled";
